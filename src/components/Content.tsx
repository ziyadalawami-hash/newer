              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {projectsList.map((project, index) => (
                  ...
                  >
                    ...
                    >
                      <div className={`absolute top-4 z-1 ${isRTL ? 'left-4' : 'right-4'} pointer-events-auto`}>
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                      ...
                      <div className="flex-1 flex flex-col p-6 pt-4 pb-20 min-h-0 overflow-y-auto pointer-events-auto relative z-1">
                        <div className="mb-3">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 px-6 py-4 flex gap-3 bg-white/99 backdrop-blur-sm pointer-events-none z-1">
                        {project.github && (
                          <a
                            href={project.github}
                            target="_blank"
